            ...
            <div className="router-profile-card">
                <div className="router-main-content">
                    <div className="router-image-section">
                        <img
                            src={require('../../assets/images/router-weights/tplink-axe300.jpeg')}
                            alt="TP-Link Archer AXE300"
                            className="router-image"
                        />
                    </div>

                    <div className="router-info-section">
                        <h2 className="router-name">TP-Link Archer AXE300</h2>
                        <p className="router-description">Wi-Fi 6E Tri-Band Router with advanced security features</p>

                        <div className="router-specs-grid">
                            <div className="spec-box">
                                <h4 className="spec-title">WI-FI STANDARD</h4>
                                <p className="spec-value">Wi-Fi 6E (802.11ax)</p>
                            </div>
                    ...
                    <div className="methodology-tab">
                        ...
                        <div className="methodology-content">
                            <div className="methodology-section">
                                ...
                                <p>For the TP-Link Archer AXE300, this calculation is:</p>
...
export default TPLinkAxe300Router;