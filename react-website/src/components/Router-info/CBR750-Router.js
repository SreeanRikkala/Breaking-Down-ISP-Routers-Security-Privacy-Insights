...
const CBR750Router = () => {
    ...
    useEffect(() => {
        import('../../assets/data/cbr750-json.json')
            .then(data => {
            ...
            <div className="router-profile-card">
                <div className="router-main-content">
                    <div className="router-image-section">
                        <img
                            src={require('../../assets/images/router-weights/cbr750.png')}
                            alt="CBR750"
                    ...
                    <div className="router-info-section">
                        <h2 className="router-name">CBR750</h2>
                        ...
                        <div className="router-specs-grid">
                            <div className="spec-box">
                                ...
                                <p className="spec-value">802.11ac</p>
                            </div>
                    ...
                    <div className="methodology-tab">
                        ...
                        <div className="methodology-content">
                            <div className="methodology-section">
                                ...
                                <p>For the CBR750, this calculation is:</p>
