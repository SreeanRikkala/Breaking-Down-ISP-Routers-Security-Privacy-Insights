...
const ArrisG54CharterRouter = () => {
    const [activeTab, setActiveTab] = useState('overview');
    const [routerData, setRouterData] = useState(null);
    const [loading, setLoading] = useState(true);

    useEffect(() => {
        import('../../assets/data/arris-g54-charter.json')
            .then(data => {
            ...
            <div className="router-profile-card">
                <div className="router-main-content">
                    <div className="router-image-section">
                        <img
                            src={require('../../assets/images/router-weights/arris-g54-charter.jpg')}
                            alt="Arris G54 Charter"
                            className="router-image"
                        />
                    </div>

                    <div className="router-info-section">
                        <h2 className="router-name">Arris G54 (Charter)</h2>
                    ...
                    <div className="methodology-tab">
                        ...
                        <div className="methodology-content">
                            <div className="methodology-section">
                                ...
                                <p>For the Arris G54 (Charter), this calculation is:</p>
...
export default ArrisG54CharterRouter;