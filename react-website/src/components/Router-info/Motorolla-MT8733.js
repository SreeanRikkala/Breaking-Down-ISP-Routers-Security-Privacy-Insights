...
const MotorolaMT8733Router = () => {
    const [activeTab, setActiveTab] = useState('overview');
    const [routerData, setRouterData] = useState(null);
    const [loading, setLoading] = useState(true);

    useEffect(() => {
        import('../../assets/data/motorola-mt8733.json')
            .then(data => {
            ...
            <div className="router-profile-card">
                <div className="router-main-content">
                    <div className="router-image-section">
                        <img
                            src={require('../../assets/images/router-weights/motorla-mt8733.jpg')}
                            alt="Motorola MT8733"
                    ...
                    <div className="router-info-section">
                        <h2 className="router-name">Motorola MT8733</h2>
                        <p className="router-description">DOCSIS 3.1 Cable Modem Router</p>
                    ...
                    <div className="methodology-tab">
                        ...
                        <div className="methodology-content">
                            <div className="methodology-section">
                                ...
                                <p>For the Motorola MT8733, this calculation is:</p>
...
export default MotorolaMT8733Router;