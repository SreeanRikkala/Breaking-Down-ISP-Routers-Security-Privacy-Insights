...
const AsusCmax6000Router = () => {
    const [activeTab, setActiveTab] = useState('overview');
    const [routerData, setRouterData] = useState(null);
    const [loading, setLoading] = useState(true);

    useEffect(() => {
        import('../../assets/data/asus-cmax6000.json')
            .then(data => {
            ...
            <div className="router-profile-card">
                <div className="router-main-content">
                    <div className="router-image-section">
                        <img
                            src={require('../../assets/images/router-weights/CMAX6000.png')}
                            alt="ASUS CM-AX6000"
                    ...
                    <div className="router-info-section">
                        <h2 className="router-name">ASUS CM-AX6000</h2>
                        ...
                        <div className="router-specs-grid">
                            ...
                            <div className="spec-box">
                                ...
                                <p className="spec-value">6000 Mbps</p>
                            </div>
                    ...
                    <div className="methodology-tab">
                        ...
                        <div className="methodology-content">
                            <div className="methodology-section">
                                ...
                                <p>For the ASUS CM-AX6000, this calculation is:</p>
...
export default AsusCmax6000Router;